...
def app_id() -> str:
    ...
    The fallback is THIS app's directory key, not the donor's ("boilerplate")
    — a copied fallback is how a satellite silently asks the hub about
    another app's tiers and keys. Same localisation lib/satellite_reporter.py
    already carries.
    """
    return os.getenv("SATELLITE_APP_KEY") or os.getenv("AD_APP_ID") or "emojimart"
