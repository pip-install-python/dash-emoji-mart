...
class AnalyticsTracker:
    ...
    def track_visit(self, path, user_agent, ip_address=None, headers=None):
        ...
        #      the CI smoke batteries look like bots to `is_bot` (it matches
        #      'python-requests' and 'curl') — they would land in `bot_hits`
        #      and be reported to the hub as crawler interest in these docs;
